...
<div align="center">
    <table border="0" width="70%">
                ...
                <td><select name="companyID">
                    ...
                    <c:forEach var="company" items="${listCompany}">
                        <option value="${company.id}"
                            ${company.id == valueSelected ? 'selected':''}>${company.companyName}</option>
                    </c:forEach>
                </select></td>
        ...
        <tr>
            <td width="35%"><input type="button" value="Đăng ký"></td>
            ...
            <td colspan="3">
                <table border="1" cellspacing="0" cellpadding="2" width="70%">
                    <tr align="center">
                        ...
                        <td>Giới tính</td>
                        <c:choose>
                            <c:when test="${sortStatus2 eq 'ASC'}">
                                <td>Ngày Sinh <label>▲</label> <a
                                        href="listUser?case=sort&typeSort=sortByBirth">▽</a>
                                </td>
                            </c:when>
                            <c:when test="${sortStatus2 eq 'DESC'}">
                                <td>Ngày Sinh <a
                                        href="listUser?case=sort&typeSort=sortByBirth">△ </a><label>▼</label>
                                </td>
                            </c:when>
                        </c:choose>
